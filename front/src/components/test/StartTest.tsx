          ...
          >
            {otherTests.length !== 0 ? (
                ...
                <div className="flex gap-2 justify-center">
                  {secondTest._id === "" ? (
                    otherTests.map((t) => (
                      <button
                        onClick={() =>
                          setSecondTest({ _id: t._id, name: t.name })
                        }
              ...
              <p className="text-4xl ">
                Your company has no more tests to pair!
              </p>
            )}
            ...
            >
              ...
              >
                <FontAwesomeIcon
                  icon={!isExplain ? faChevronDown : faChevronUp}
                />{" "}
                What is pair?
              </button>
              {isExplain && (
                <p className="w-[95%]">
                  You can run two tests at the same time in order to get all the
                  benefits of A/B testing. It is not necessary to do this and
                  you can stop at one test if you do not have a device or
                  product for the second one.
                </p>
              )}
            </div>
            ...
            <div className="flex justify-around w-2/3">
              ...
              <div onClick={handleSubmit} className="w-1/3">
                <Button
                  ...
                  size="medium"
                  icon={
                    endDate !== "" ? <FontAwesomeIcon icon={faRocket} /> : null
                  }
                  isDisabled={endDate === ""}
                >
                  Start
